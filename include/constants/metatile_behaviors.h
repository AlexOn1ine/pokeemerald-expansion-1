...
#define MB_UNUSED_0x11 0x11 // Used by interior maps; functionally the same as MB_DEEP_WATER
...
#define MB_UNUSED_0x18 0x18
#define MB_NO_SURFACING 0x19
#define MB_UNUSED_0x1A 0x1A
