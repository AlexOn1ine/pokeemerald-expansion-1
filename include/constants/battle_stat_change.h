...
enum StatChangeResult
{
    ...
    STAT_CHANGE_DONE_ALLY,
    STAT_CHANGE_BLOCKED_BY_TARGET,
};

enum StatChangeProcess
{
    PROCESS_STAT_DEFAULT,
    PROCESS_STAT_CHANGE_PREVENTED,
    PROCESS_STAT_AT_MAX, // No change
    PROCESS_STAT_AT_MIN, // No change
    PROCESS_STAT_INCREASING,
    PROCESS_STAT_DECREASING,
};
