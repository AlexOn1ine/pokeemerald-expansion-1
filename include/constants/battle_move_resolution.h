...
{
    STAT_CHANGE_MOVE_FAILURE,
    STAT_CHANGE_SUBSTITUTE,
    STAT_CHANGE_ACCURACY,
    STAT_CHANGE_PREPARE_STATS,
    STAT_CHANGE_PREVENTED_ALLIED_SIDE,
    STAT_CHANGE_PREVENTED_OPPOSING_SIDE,
    STAT_CHANGE_BEFORE_CHANGE,
    STAT_CHANGE_TRY_CHANGE_ALLIED_SIDE,
    STAT_CHANGE_TRY_CHANGE_OPPOSING_SIDE,
    STAT_CHANGE_ADDITIONAL_EFFECT,
    STAT_CHANGE_COUNT,
};
