...
extern const u8 BattleScript_ItemStatRaise[];
extern const u8 BattleScript_BerryStatRaiseRippen[];
...
extern const u8 BattleScript_AbilityStatChangeEnd2[];
extern const u8 BattleScript_AbilityStatChange[];
extern const u8 BattleScript_MoveEffectStatChange[];
extern const u8 BattleScript_MoveEffectStatChangeSide[];
...
extern const u8 BattleScript_DefiantRattledActivates[];
...
extern const u8 BattleScript_EffectStatChangeUser[];
...
extern const u8 BattleScript_MoveEffectWeightLoss[];
...
extern const u8 BattleScript_EffectStatChangeTarget[];
